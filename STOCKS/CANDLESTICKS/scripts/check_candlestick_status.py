#!/usr/bin/env python3
"""
Check current candlestick resumption status.
"""
...
def check_status():
    ...
    try:
        ...
        print("📊 CANDLESTICK RESUMPTION STATUS")
        print("=" * 50)
        ...
        print(f"Intraday Updated: {len(state_dict.get('intraday_updated', []))}")
        print(f"Unadjusted Updated: {len(state_dict.get('unadj_updated', []))}")
        print(f"Adjusted Updated: {len(state_dict.get('adj_updated', []))}")
