...
OVERVIEW_PNG = REPORTS_DIR / "transactions_report_overview.png"
TIMELINE_PNG = REPORTS_DIR / "transactions_report_timeline.png"

# Legacy text/json reports to remove
LEGACY_STATUS_JSON = REPORTS_DIR / "transactions_status_report.json"
...
def main():
    ...
    fig.suptitle("Transactions Pipeline Report - Overview", fontsize=16, fontweight="bold")
    ...
    ax.legend(wedges, [f"{l}: {v:,}" for l, v in zip(labels, values)], loc="lower center", bbox_to_anchor=(0.5, -0.15), ncol=1)

    # Helper and reputation counts
    ax = axes[1, 0]
    ...
    fig.suptitle("Transactions Pipeline Report - Recent Timeline", fontsize=16, fontweight="bold")
